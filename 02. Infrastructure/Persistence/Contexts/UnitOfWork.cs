...
public class UnitOfWork : IUnitOfWork
{
    ...
    public async void CreateContext(bool isReadOnly)
    {
        await DisposeAsync();
        Context = _contextFactory.CreateDbContext(isReadOnly);
    }
    ...
    public Task UpdateRangeAsync<T>(IList<T> entities) where T : class
    {
        try
        {
    ...
    public Task RemoveRangeAsync<T>(IList<T> entities) where T : class
    {
        try
        {
    ...
    public async Task BulkInsertAsync<T>(IList<T> entities, BulkConfig? config) where T : class
    {
    ...
    public async Task BulkUpdateAsync<T>(IList<T> entities, BulkConfig? config) where T : class
    {
        using var transaction = await Context.Database.BeginTransactionAsync();
        try
        {
    ...
    public async Task BulkDeleteAsync<T>(IList<T> entities, BulkConfig? config) where T : class
    {
        using var transaction = await Context.Database.BeginTransactionAsync();
        try
        {
    ...
    public async Task BulkInsertOrUpdateAsync<T>(IList<T> entities, BulkConfig? config) where T : class
    {
    ...
    #region Dispose
    // بعد از بسته شدن سرویس در IAsyncDisposable
